...
namespace UedConverter.UtxFile
{
    public struct USize
    {
        public USize(int Width, int Height) { this.Width = Width; this.Height = Height; }
        public int Width;
        public int Height;
    };
    internal static class TextureSizeDictionary
    {
        private static string TextureSizeDictionaryFilename = "texture_dict.txt";
        ...
        private static Regex dimensionToNameRegex = new Regex(@"^(.+) (\d+)x(\d+)$", RegexOptions.Compiled);
    }
}
